...
function Draggable({ id, size, children, onDragMove, onHidden, isSizingDynamic, availableSizes = ["sm", "md", "lg", "xl"], language = "en-US" }) {
                  ...
                  /* @__PURE__ */ jsxs2(DropdownMenuRadioGroup, { value: sizing, onValueChange: handleChangeSizing, children: [
                    /* @__PURE__ */ jsx3(
                      DropdownMenuRadioItem,
                      {
                        ...
                        children: language === "pt-BR" ? "Pequeno(sm)" : "Small(sm)"
                      }
                    ),
                    /* @__PURE__ */ jsx3(
                      DropdownMenuRadioItem,
                      {
                        value: "md",
                        disabled: !availableOptionSizes.includes("sm"),
                        children: language === "pt-BR" ? "M\xE9dio(md)" : "Medium(md)"
                      }
                    ),
                    /* @__PURE__ */ jsx3(
                      DropdownMenuRadioItem,
                      {
                        value: "lg",
                        disabled: !availableOptionSizes.includes("sm"),
                        children: language === "pt-BR" ? "Grande(lg)" : "Larger(lg)"
                      }
                    ),
                    /* @__PURE__ */ jsx3(
                      DropdownMenuRadioItem,
                      {
                        value: "xl",
                        disabled: !availableOptionSizes.includes("sm"),
                        children: language === "pt-BR" ? "Extra Grande(xl)" : "Extra Larger(xl)"
                      }
                    )
                  ] })
                ] })
