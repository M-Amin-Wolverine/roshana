...
import { l as useFloating, n as autoPlacement, o as offset, r as flip, s as shift, t as arrow, u as autoUpdate } from "./floating-ui.react-dom-DH3leU2m.js";
import { t as require_react_innertext } from "./react-innertext-CxmGrreE.js";
import { t as require_shim } from "./shim-BFWKE9p_.js";
...
function compareValues(left, right, seen) {
	...
	if (!left || !isObject$1(left) || !right || !isObject$1(right)) return false;
...
function validateDependencies(dependencies, name, fallback) {
	if (!(dependencies instanceof Array) || !dependencies.length) console.warn(`${name} should not be used with no dependencies. Use React.${fallback} instead.`);
	if (dependencies.length && dependencies.every(isPrimitive$1)) console.warn(`${name} should not be used with dependencies that are all primitive values. Use React.${fallback} instead.`);
}
...
canUseDOM$1() ? import_react.useLayoutEffect : import_react.useEffect;
...
var isPlainObject = (value) => {
	if (getObjectType$1(value) !== "Object") return false;
