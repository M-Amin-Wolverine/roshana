...
//#region node_modules/split.js/dist/split.es.js
...
var Split = function(idsOption, options) {
	...
	elements.forEach(function(element) {
		...
		if (computedSize < element.minSize) if (expandToMin) adjustToMin(element);
		else element.minSize = computedSize;
	});
...
//#endregion
//#region node_modules/react-split/dist/react-split.es.js
...
var SplitWrapper = /* @__PURE__ */ function(superclass) {
	...
	SplitWrapper.prototype.componentDidMount = function componentDidMount() {
		...
		var options = objectWithoutProperties(ref, ["children", "gutter"]);
		options.gutter = function(index, direction) {
			var gutterElement;
			if (gutter) gutterElement = gutter(index, direction);
			else {
	...
	SplitWrapper.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
		...
		var options = objectWithoutProperties(ref, [
			"children",
			"minSize",
			"sizes",
			"collapsed"
		...
		} else if (Array.isArray(minSize) || Array.isArray(prevMinSize)) needsRecreate = true;
		else needsRecreate = needsRecreate || minSize !== prevMinSize;
		if (needsRecreate) {
			...
			this.split = Split(Array.from(this.parent.children).filter(function(element) {
			...
			if (sizeChanged) this.split.setSizes(this.props.sizes);
		}
		if (Number.isInteger(collapsed) && (collapsed !== prevCollapsed || needsRecreate)) this.split.collapse(collapsed);
	};
	...
	SplitWrapper.prototype.render = function render() {
		...
		return import_react.createElement("div", Object.assign({}, { ref: function(parent) {
...
SplitWrapper.propTypes = {
	...
	minSize: import_prop_types.default.oneOfType([import_prop_types.default.number, import_prop_types.default.arrayOf(import_prop_types.default.number)]),
	maxSize: import_prop_types.default.oneOfType([import_prop_types.default.number, import_prop_types.default.arrayOf(import_prop_types.default.number)]),
	...
	snapOffset: import_prop_types.default.oneOfType([import_prop_types.default.number, import_prop_types.default.arrayOf(import_prop_types.default.number)]),
...
//#endregion
export { SplitWrapper as default };
