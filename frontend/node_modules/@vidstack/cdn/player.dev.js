...
class TextTrack extends EventsTarget {
  ...
  /** @internal */
  [(_a$4 = TextTrackSymbol._readyState, _b$2 = TextTrackSymbol._onModeChange, _c$1 = TextTrackSymbol._native, TextTrackSymbol._updateActiveCues)](currentTime, trigger) {
  ...
  async _load() {
    ...
    try {
      const { parseResponse, VTTCue, VTTRegion } = await import('https://cdn.vidstack.io/captions'), crossOrigin = this[TextTrackSymbol._crossOrigin]?.();
...
const intervalJobs = /* @__PURE__ */ new Set();
{
  window.setInterval(() => {
...
function scheduleIntervalJob(job) {
  ...
  constructor() {
    ...
    this._selectTracks = functionDebounce(async () => {
      ...
      for (const kind of kinds) {
        ...
        const defaultTrack = isArray$1(kind) ? this._defaults[kind.find((kind2) => this._defaults[kind2]) || ""] : this._defaults[kind];
...
class MediaPlayerDelegate {
  ...
  async _ready(info, trigger) {
    return untrack(async () => {
      ...
      const savedPlaybackTime = savedState()?.currentTime, savedPlayingState = savedState()?.paused === false, storageTime = await storage?.getTime(), startTime = savedPlaybackTime ?? storageTime ?? clipStartTime(), shouldAutoPlay = savedPlayingState || savedPlayingState !== false && !started() && autoPlay();
      if (provider) {
...
class MediaRequestManager extends MediaPlayerController {
  ...
  ["media-audio-gain-change-request"](event) {
    ...
    if (audioGain() === event.detail || !canSetAudioGain())
      return;
    const provider = this._$provider();
    if (!provider?.audioGain)
      return;
...
class AudioProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await Promise.resolve().then(function () { return provider$5; })).AudioProvider(this.target, ctx);
  }
}
...
class VideoProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await Promise.resolve().then(function () { return provider$4; })).VideoProvider(this.target, ctx);
  }
}
...
AirPlayButton$1.props = ToggleButtonController.props;
...
VolumeSlider$1.props = {
  ...SliderController.props,
  keyStep: 5,
  shiftKeyMultiplier: 2
};
VolumeSlider$1.state = sliderState;
...
TimeSlider$1.state = sliderState;
...
class SliderChapters extends Component {
  ...
  onSetup() {
    this._media = useMediaContext();
    this._sliderState = useState(TimeSlider$1.state);
  }
  onAttach(el) {
...
__decorateClass$a([
  prop
], Menu$1.prototype, "triggerElement", 1);
__decorateClass$a([
  prop
], Menu$1.prototype, "contentElement", 1);
__decorateClass$a([
  prop
], Menu$1.prototype, "isSubmenu", 1);
__decorateClass$a([
  method
], Menu$1.prototype, "open", 1);
__decorateClass$a([
  method
], Menu$1.prototype, "close", 1);
...
__decorateClass$9([
  prop
], MenuButton$1.prototype, "expanded", 1);
...
AudioRadioGroup$1.props = {
  emptyLabel: "Default"
};
__decorateClass$5([
  prop
], AudioRadioGroup$1.prototype, "value", 1);
__decorateClass$5([
  prop
], AudioRadioGroup$1.prototype, "disabled", 1);
__decorateClass$5([
  method
], AudioRadioGroup$1.prototype, "getOptions", 1);
...
CaptionsRadioGroup$1.props = {
  offLabel: "Off"
};
__decorateClass$3([
  prop
], CaptionsRadioGroup$1.prototype, "value", 1);
__decorateClass$3([
  prop
], CaptionsRadioGroup$1.prototype, "disabled", 1);
__decorateClass$3([
  method
], CaptionsRadioGroup$1.prototype, "getOptions", 1);
...
SpeedRadioGroup$1.props = {
  normalLabel: "Normal",
  rates: DEFAULT_PLAYBACK_RATES
};
__decorateClass$2([
  prop
], SpeedRadioGroup$1.prototype, "value", 1);
__decorateClass$2([
  prop
], SpeedRadioGroup$1.prototype, "disabled", 1);
__decorateClass$2([
  method
], SpeedRadioGroup$1.prototype, "getOptions", 1);
...
__decorateClass$1([
  prop
], QualityRadioGroup$1.prototype, "value", 1);
__decorateClass$1([
  prop
], QualityRadioGroup$1.prototype, "disabled", 1);
__decorateClass$1([
  method
], QualityRadioGroup$1.prototype, "getOptions", 1);
...
let Captions$1 = class Captions extends Component {
  ...
  onConnect(el) {
    ...
    import('https://cdn.vidstack.io/captions').then((lib) => {
      if (!this.connectScope)
        return;
      scoped(() => {
        this._lib = lib;
...
let PlyrLayout$1 = class PlyrLayout extends Component {
  onSetup() {
    this._media = useMediaContext();
...
PlyrLayout$1.props = plyrLayoutProps;
...
class MediaProviderElement extends Host(HTMLElement, MediaProvider) {
  ...
  _createVideo() {
    ...
    const { controls, crossOrigin, poster } = this._media.$state, { $iosControls } = this._media, $nativeControls = computed(() => controls() || $iosControls() ? "true" : null), $poster = computed(() => poster() && (controls() || $iosControls()) ? poster() : null);
    effect(() => {
  ...
  _createIFrame() {
    const iframe = this._target instanceof HTMLIFrameElement ? this._target : document.createElement("iframe");
    const { controls } = this._media.$state, { $iosControls } = this._media, $nativeControls = computed(() => controls() || $iosControls());
...
DefaultLayout.props = defaultLayoutProps;
__decorateClass([
  prop
...
_DefaultAudioLayout.props = {
  ...__superGet$1(_DefaultAudioLayout, _DefaultAudioLayout, "props"),
  when: ({ viewType }) => viewType === "audio",
  smallWhen: ({ width }) => width < 576
};
let DefaultAudioLayout$1 = _DefaultAudioLayout;
...
function DefaultResetMenuItem() {
  const { translations } = useDefaultLayoutContext(), $label = () => i18n$1(translations, "Reset"), resets = useContext(resetContext);
  function onClick() {
...
function DefaultFontSetting({
  ...
  const { player } = useMediaContext(), { translations } = useDefaultLayoutContext(), resets = useContext(resetContext), key = `${group}-${label.toLowerCase()}`, $value = signal(defaultValue), $label = () => i18n$1(translations, label);
...
class MediaVideoLayoutElement extends Host(LitElement, DefaultVideoLayout) {
  ...
  _render() {
    const { load } = this._media.$props, { canLoad, streamType } = this._media.$state;
...
MediaAnnouncerElement.tagName = "media-announcer";

class MediaAirPlayButtonElement extends Host(HTMLElement, AirPlayButton$1) {
}
MediaAirPlayButtonElement.tagName = "media-airplay-button";
...
MediaGoogleCastButtonElement.tagName = "media-google-cast-button";
...
MediaAudioGainRadioGroupElement.tagName = "media-audio-gain-radio-group";
...
MediaSliderStepsElement.tagName = "media-slider-steps";
...
MediaSpeedSliderElement.tagName = "media-speed-slider";
...
MediaTitleElement.tagName = "media-title";
...
class GoogleCastLoader {
  ...
  async load(ctx) {
    ...
    return new (await Promise.resolve().then(function () { return provider; })).GoogleCastProvider(this._player, ctx);
  }
...
const videoIdRE$1 = /(?:https:\/\/)?(?:player\.)?vimeo(?:\.com)?\/(?:video\/)?(\d+)(?:\?hash=(.*))?/;
...
async function getVimeoVideoInfo(videoId, abort) {
  ...
  if (pendingFetch$1.has(videoId))
    return pendingFetch$1.get(videoId);
...
const icons$2 = {
  ...
  "menu-audio": Icon$51,
  "menu-audio-boost-up": Icon$101,
  "menu-audio-boost-down": Icon$102,
  "menu-playback": Icon$60,
  "menu-speed-up": Icon$33,
  "menu-speed-down": Icon$32,
  "menu-captions": Icon$25,
  "menu-quality-up": Icon$12,
  "menu-quality-down": Icon$7,
  ...
  "kb-pause": Icon$56,
  "kb-mute": Icon$52,
  "kb-volume-up": Icon$101,
  "kb-volume-down": Icon$102,
  "kb-fs-enter": Icon$38,
  "kb-fs-exit": Icon$37,
  "kb-pip-enter": Icon$58,
  "kb-pip-exit": Icon$57,
  "kb-cc-on": Icon$24,
  "kb-cc-off": Icon$25,
  "kb-seek-forward": Icon$33,
  "kb-seek-backward": Icon$32
};
...
class MediaPlyrLayoutElement extends Host(LitElement, PlyrLayout$1) {
  onSetup() {
    this.forwardKeepAlive = false;
    this._media = useMediaContext();
  }
...
MediaPlyrLayoutElement.tagName = "media-plyr-layout";
