...
:where(.vds-slider-step) {
  width: 2.5px;
  height: 6px;
  background-color: var(--media-menu-slider-step-color, rgb(124, 124, 124));
  opacity: 0;
...
:where(.vds-tooltip-content) {
  display: inline-block;
  box-sizing: border-box;
  color: var(--media-tooltip-color, #f5f5f5);
  background-color: var(--media-tooltip-bg-color, black);
  border: var(--media-tooltip-border);
  font-family: var(--media-font-family, sans-serif);
...
@media (prefers-color-scheme: light) {
  :where(.vds-tooltip-content) {
    color: var(--media-tooltip-color, #1a1a1a);
    background-color: var(--media-tooltip-bg-color, white);
  }

  .vds-tooltip-content {
    border: var(--media-tooltip-border, 1px solid rgb(0 0 0 / 0.2));
  }
}

:where(.light .vds-tooltip-content) {
  color: var(--media-tooltip-color, #1a1a1a);
  background-color: var(--media-tooltip-bg-color, white);
}
